...
При вычислении получим $ln \text{ }0$, но логарифма с аргументом равным нулю не существует, следовательно, точка с координатами $(1, 0)$ является асимптотой графика функции $ln(1-x)$. Функция $ln(1-x)$ - убывающая, следовательно:
